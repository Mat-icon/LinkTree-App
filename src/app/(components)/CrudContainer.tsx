// components/CrudContainer.tsx
import React, { useState, useEffect } from "react";
import { Bars2Icon, ChevronDownIcon, ChevronUpIcon, LinkIcon } from "@heroicons/react/16/solid";
import { FaGithub, FaYoutube, FaLinkedin, FaFacebook, FaUserAstronaut, FaTwitch, FaCodepen, FaFreeCodeCamp } from "react-icons/fa";
...
const CrudContainer: React.FC<CrudContainerProps> = ({ id, index, onRemove, onLinkChange }) => {
  ...
  return (
    <div className="w-full bg-gray-50 rounded-xl p-4 space-y-2 mt-6">
      <div className="flex items-center justify-between">
        ...
        <button className="text-sm text-gray-500" onClick={() => onRemove(id)}>Remove</button>
      </div>
