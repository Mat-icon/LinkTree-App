...
const PreviewPage: React.FC = () => {
  ...
  return (
    <div className="w-5/12 h-auto bg-white rounded-xl lg:flex items-center justify-center hidden md:hidden">
      <div className="relative bg-white rounded-3xl border border-gray-500 p-2 phone">
        {" "}
        <div className="w-5/12 absolute -top-8 left-20 h-14 border-b border-gray-500 rounded-b-xl"></div>
            ...
            {isLoading ? (
              ...
              <>
                ...
                <div className="flex flex-col items-center">
                  <h2 className="mt-4 text-xl font-semibold w-11/12 text-center">
